...
public class EnergyTransmitterNodeMenu extends AbstractContainerMenu {
    public final EnergyTransmitterNodeBlockEntity blockEntity;
    private final Level level;
    private final ContainerLevelAccess access;

    public EnergyTransmitterNodeMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public EnergyTransmitterNodeMenu(int containerId, Inventory inv, BlockEntity entity) {
        super(JTMenuTypes.ENERGY_TRANSMITTER_NODE_MENU.get(), containerId);
        checkContainerSize(inv, 1);
        blockEntity = ((EnergyTransmitterNodeBlockEntity) entity);
        ...
        // Single upgrade slot at same position as other systems
